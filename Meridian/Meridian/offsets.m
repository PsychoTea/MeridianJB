...
int load_offsets(void)
{
    ...
    // iPhone 7 (GSM) and iPhone 7 (Global)
    ...
    if(!strcmp(device, "iPhone9,3"))
    {
        ...
        if(!strcmp(osversion, "14D27"))
        {
            ...
            OFFSET_IPC_KOBJECT_SET                 = 0xfffffff0070f27a4;
            OFFSET_IPC_PORT_MAKE_SEND              = 0xfffffff0070dec80;
            OFFSET_IOSURFACEROOTUSERCLIENT_VTAB    = 0xfffffff006e521e0;
            OFFSET_ROP_ADD_X0_X0_0x10              = 0xfffffff0063e529c;
            OFFSET_OSSERIALIZER_SERIALIZE          = 0xfffffff007491a60;
            OFFSET_ROP_LDR_X0_X0_0x10              = 0xfffffff006330ab8;
        ...
        if(!strcmp(osversion, "14C92"))
        {
            ...
            OFFSET_IPC_PORT_ALLOC_SPECIAL          = 0xfffffff0070df13c;
            OFFSET_IPC_KOBJECT_SET                 = 0xfffffff0070f2780;
            OFFSET_IPC_PORT_MAKE_SEND              = 0xfffffff0070dec80;
            OFFSET_IOSURFACEROOTUSERCLIENT_VTAB    = 0xfffffff006e521e0;
            OFFSET_ROP_ADD_X0_X0_0x10              = 0x00b592b8;
            OFFSET_OSSERIALIZER_SERIALIZE          = 0xfffffff007491a3c;
            OFFSET_ROP_LDR_X0_X0_0x10              = 0x00261884;
        ...
        if(!strcmp(osversion, "14A551"))
        {
            ...
            OFFSET_IPC_KOBJECT_SET                 = 0xfffffff0070f16b4;
            OFFSET_IPC_PORT_MAKE_SEND              = 0xfffffff0070de2dc;
            OFFSET_IOSURFACEROOTUSERCLIENT_VTAB    = 0xfffffff006e521e0;
            OFFSET_ROP_ADD_X0_X0_0x10              = 0x00b5d2b8;
            OFFSET_OSSERIALIZER_SERIALIZE          = 0xfffffff007490240;
            OFFSET_ROP_LDR_X0_X0_0x10              = 0x00260de0;
    ...
    if(!strcmp(device, "iPhone9,1"))
    {
        ...
        if(!strcmp(osversion, "14D27"))
        {
            ...
            OFFSET_ROP_ADD_X0_X0_0x10              = 0x00b592b8;
            OFFSET_OSSERIALIZER_SERIALIZE          = 0xfffffff007491a60;
            OFFSET_ROP_LDR_X0_X0_0x10              = 0x002618a8;
    ...
    // iPhone 7 Plus (Global) and iPhone 7 Plus (GSM)
    if(!strcmp(device, "iPhone9,2") || !strcmp(device, "iPhone9,4"))
    {
        // 10.3.3
        if(!strcmp(osversion, "14G60"))
        {
    ...
    LOG("%s", kern_version);
    LOG("Loading offsets for device %s (Build %s)", device, osversion);
    LOG("Test offset x0x0x10 Gadget: 0x%llx", OFFSET_ROP_ADD_X0_X0_0x10);
    
    return OFFSET_ROP_ADD_X0_X0_0x10 == 0;
}
