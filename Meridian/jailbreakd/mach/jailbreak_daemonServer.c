/*
 * IDENTIFICATION:
 * stub generated Mon Aug 13 10:31:42 2018
...
#pragma pack()
	...
	__DeclareRcvRpc(1337, "call")
	__BeforeRcvRpc(1337, "call")
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 1337) || (InHeadP->msgh_id < 1337) ||
	    ((routine = jbd_jailbreak_daemon_subsystem.routine[InHeadP->msgh_id - 1337].stub_routine) == 0)) {
