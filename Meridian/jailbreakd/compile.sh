...
xcrun -sdk iphoneos gcc -arch arm64 -framework Foundation -framework IOKit -o $currDir/$outputFile kern_utils.m kexecute.c kmem.c main.m offsetof.c osobject.c patchfinder64.c sandbox.m
